...
export default function NewStudentGuardianLinkPage() {
  ...
  const loadSummary = useCallback(async (): Promise<PageData | null> => {
    ...
    const [studentSnap, guardiansSnap, peopleSnap] = await Promise.all([
      getDoc(studentRef),
  ...
  return (
    <div className="space-y-6">
      ...
      <FormSection
        title="بيانات الرابط"
        description="اختر ولي الأمر ونوع العلاقة وحالة الرابط."
