...
import {
  ...
  filterStaffPdfFilesForScopeTargets,
...
export function StaffPdfFileCategoryWorkspace(props: {
  ...
  const scopeTargetFiles = useMemo(
    () => filterStaffPdfFilesForScopeTargets(visibleFiles),
    [visibleFiles],
  );
  const filteredFiles = useMemo(() => {
    const normalizedSearch = search.trim().toLocaleLowerCase("ar");
    const filesForView = view === "SCOPE" ? scopeTargetFiles : visibleFiles;
    return filesForView.filter((file) => {
